...
plotting_taxa <- ggplot(taxa_table_plus_metadata_genus, aes(x=Treatment, y=ASV656))  + geom_smooth(method="lm") + geom_jitter()
plotting_taxa
...
plotting_taxa <- ggplot(taxa_table_plus_metadata_asv, aes(x=Treatment, y=ASV429)) + geom_jitter() + geom_smooth(method="lm")
plotting_taxa
...
##There were associations between covariates of interest and taxa. DESeq2 was used to analyze the association between bacterial taxa and study covariates at the genus and species (ASV) level. 
```
