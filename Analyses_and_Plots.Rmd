...
library("knitr")
library("OneR")
seqtab <- readRDS("C:/Users/hammera/Desktop/raber_550/data/280_seqtab_final.rds")
seqtab.taxa <- readRDS("C:/Users/hammera/Desktop/raber_550/data/280_taxa_final.rds")
seqtab <- (seqtab)
...
physeq_s1 <- rarefy_even_depth(physeq_s1)
#physeq_genus_rare <- rarefy_even_depth(physeq_genus_rare)
#physeq_s1_genus <- tax_glom(physeq_s1, "Genus")
...
merged_physeq <- merge_phyloseq(physeq_s1, physeq)
merged_physeq_subset <- subset_samples(merged_physeq, Treatment=="0")
merged_physeq_ordination <- ordinate(merged_physeq_subset, method="NMDS", distance="bray")
plot_merged_physeq_ordination <- plot_ordination(merged_physeq_subset, merged_physeq_ordination, type="samples", color="Study")
...
new_merged_physeq <- merge_phyloseq(new_physeq_s1, rarefy_even_depth(physeq))
new_merged_physeq <- subset_samples(new_merged_physeq, Treatment=="0")
new_physeq_ordination_merged <- ordinate(merged_physeq_subset, method="NMDS", distance="bray")
