...
stat_ellipse(aes(),data=data.frame(sample_data(physeq1)$Treatment), type="euclid")
...
treatment.env <- sample_data(physeq1)$Alphadiv
physeq1.envfit <- envfit(physeq1.ord, treatment.env, perm=5000)
plot(physeq1.envfit)
