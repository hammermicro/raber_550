...
```{r DESeq_analyses_by_covariate, echo=FALSE}
...
print(Treatment_Sex_ASVs)
print(Treatment_Sex_genus)
plotting_taxa <- ggplot(taxa_table_plus_metadata_asv_rare, aes(x=Treatment, y=ASV231), color=Sex) + geom_point() + geom_smooth(method="auto") + facet_grid(rows=vars(Sex))
plotting_taxa
