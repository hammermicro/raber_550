...
## With some covariates the scores are reasonably close to each other, which could result in a very small difference between groups 1, 2, and 3, whereas the 4 group is way out. Additionally, the issue of many zeros in the data makes it hard to infer if a particular trend is driven by specific microbes, or just a stochastic artifact.
```
