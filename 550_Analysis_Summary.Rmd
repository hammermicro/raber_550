...
set.seed(1)
perm.results.treatment <- adonis(physeq2.dist ~PALatencyDiff, data=sampledf, permutations=5000)
...
treatdds = phyloseq_to_deseq2(phyloseq_object, ~PALatCross)
...
treatdds = phyloseq_to_deseq2(physeq_genus, ~PALatCross)
## Genus level table
