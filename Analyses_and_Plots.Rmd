...
library(ggplot2)
set.seed(1)
physeq_nmds = metaMDS(otu_table(physeq2), distance="jaccard", k=3, trymax=500, data=treatment.env, verbose=FALSE)
...
library("vegan")
set.seed(1)
physeq1.dist <- vegdist(otu_table(physeq2), method="bray")
...
multi_figure <- grid.arrange(OFTotDistDay1_table,
PALatCross_table,
PALatencyDiff_table,
OFCentDur1_table,
NOObjpref_table,
