...
sample_data(physeq_s1_genus)$Treatment <- factor(sample_data(physeq_s1_genus)$Radiation.Conc.cGy)
sample_data(physeq_s1_genus)$Study <- "Three-beam"
sample_data(physeq_genus)$Study <- "Six-beam"
merged_physeq <- merge_phyloseq(physeq_s1_genus, physeq_genus)
merged_physeq <- subset_samples(merged_physeq, Treatment=="0")
merged_physeq_ordination <- ordinate(merged_physeq, method="NMDS", distance="bray")
plot_merged_physeq_ordination <- plot_ordination(merged_physeq, merged_physeq_ordination, type="samples", color="Study")
