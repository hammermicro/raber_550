...
plot(nmds_table[,1], nmds_table[,4], main="Bray-Curtis 1:3", pch=20, col=c("(treatment.env$Treatment)
physeq1_ordination <- plot_ordination(physeq1, physeq1.ord, type="samples", color="Treatment", title="ByTreatment", shape="Sex") + stat_ellipse(level=0.4)
...
physeq1.ord.plot <- plot_ordination(physeq1, physeq1.ord, type="samples", color="Sex", title="BySex", shape="Treatment") + stat_ellipse(level=0.4)
plot(physeq1.ord.plot)
physeq1.ord.treatment <- plot_ordination(physeq1, physeq1.ord, type="samples", color="Treatment", title="ByTreatment", shape="Sex") + stat_ellipse(level=0.4)
plot(physeq1.ord.treatment)
