...
testing_cor_adiv <- cor.test(x=corr_df$FSTTimeImmobile, y=(as.matrix(corr_df$Alphadiv)), method=c("spearman"))
print(testing_cor_adiv)
lm_testing <- lm(as.matrix(Alphadiv) ~ FSTTimeImmobile, data=corr_df)
ggplot(corr_df, aes(x=FSTTimeImmobile, y=as.matrix(Alphadiv)), ylab="Shannon") + geom_smooth(method="lm", ylab="Shannon") + geom_point(aes(color=FSTTimeImmobile_binned)) + ylab("Shannon") + xlab("Forced Swim Test Time Immobile")
...
taxa_with_deseq <- function(treatdds, physeq1){ 
  ...
  print(EnhancedVolcano(res2, lab=rownames(res2), x='log2FoldChange', y='pvalue') + ggtitle(""))
...
treatdds = phyloseq_to_deseq2(physeq1, ~OFTotDistDay1)
...
## DESeq2 analysis using the specified covariate (ASV level)
treatdds = phyloseq_to_deseq2(physeq1, ~FSTTimeImmobile)
## Generated table containing ASVs
...
treatdds = phyloseq_to_deseq2(physeq1, ~NOObjpref)
## Generated table containing ASVs
...
## Convert to deseq2 object using the specified covariate
treatdds = phyloseq_to_deseq2(physeq1, ~OFCentDur1)
## Generated table containing ASVs
...
treatdds = phyloseq_to_deseq2(physeq_genus1, ~Treatment)
## Genus level table
Treatment_genus <- taxa_with_deseq(treatdds, physeq_genus1)
...
## Convert to deseq2 object using the specified covariate
treatdds = phyloseq_to_deseq2(physeq1, ~Sex*Treatment)
## Generated table containing ASVs
...
## Convert to deseq2 object using the specified covariate
treatdds = phyloseq_to_deseq2(physeq1, ~FSTTimeImmobile_binned)
## Generated table containing ASVs
...
##plotting_taxa <- ggplot(taxa_table_plus_metadata_asv_rare, aes(x=FSTTimeImmobile_binned, y=ASV264))  + geom_boxplot()
##plotting_taxa
```

```{r ASV_by_NOObjpref_binned, echo=FALSE}
## Convert to deseq2 object using the specified covariate
treatdds = phyloseq_to_deseq2(physeq1, ~NOObjpref_binned)
## Generated table containing ASVs
...
## Convert to deseq2 object using the specified covariate
treatdds = phyloseq_to_deseq2(physeq1, ~OFCentDur1_binned)
## Generated table containing ASVs
...
## Convert to deseq2 object using the specified covariate
treatdds = phyloseq_to_deseq2(physeq1, ~OFTotDistDay1_binned)
## Generated table containing ASVs
...
##ASVs: 316 (consider binned vs non, this illustrates the difficulty of making inferences driven by a single point)
...
## Convert to deseq2 object using the specified covariate
treatdds = phyloseq_to_deseq2(physeq1, ~PALatencyDiff_binned)
## Generated table containing ASVs
...
## Convert to deseq2 object using the specified covariate
treatdds = phyloseq_to_deseq2(physeq1, ~PALatCross_binned)
## Generated table containing ASVs
...
set.seed(1)
study_difference_permanova <- adonis(study_object_dist ~ Treatment, data=merged_df, permutations=5000)
